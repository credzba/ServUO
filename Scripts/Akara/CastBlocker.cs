...
namespace Server.Items
{
	public class CastBlocker : Item
	{
		...
		{
			TileData.ItemTable[0x2199].Flags = TileFlag.NoShoot; // TileFlag.Impassible removed to fix losblockers
																// that stopped players from walking over. Slave Labor, Akara Essex, 8/16/2012.
