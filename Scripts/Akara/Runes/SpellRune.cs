   	...
   	{ 
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			...
			//	if ( Spell1 && Spell1Keyword != null && Spell1Keyword != "" && e.Speech.ToLower().IndexOf( Spell1Keyword.ToLower() ) >= 0 ) 
				if ( Spell1 && Spell1Keyword != null && Spell1Keyword != "" && e.Speech.ToLower() == Spell1Keyword.ToLower() )
				{
				...
				else if ( Spell2 && Spell2Keyword != null && Spell2Keyword != "" && e.Speech.ToLower() == Spell2Keyword.ToLower() )
				{
				//else if ( Spell2 && Spell2Keyword != null && Spell2Keyword != "" && e.Speech.ToLower().IndexOf( Spell2Keyword.ToLower() ) == 0 )
					...
					else if ( Spell3 && Spell3Keyword != null && Spell3Keyword != "" && e.Speech.ToLower() == Spell3Keyword.ToLower() )
					{
				...
				else if ( Spell4 && Spell4Keyword != null && Spell4Keyword != "" && e.Speech.ToLower() == Spell4Keyword.ToLower() )
				{
				//else if ( Spell4 && Spell4Keyword != null && Spell4Keyword != "" && e.Speech.ToLower().IndexOf( Spell4Keyword.ToLower() ) >= 0 )
				
					if ( !SpellRune.DisFire && Type == RuneType.Fire )
						new Server.Spells.HeatWave( from, null, this ).Cast();
					if ( !SpellRune.DisWater && Type == RuneType.Water )
						new Server.Spells.Whirlpool( from, null, this ).Cast();
					if ( !SpellRune.DisWind && Type == RuneType.Wind )
						new Server.Spells.Revitalization( from, null, this ).Cast();
					if ( !SpellRune.DisEarth && Type == RuneType.Earth )
						new Server.Spells.StoneSkin( from, null, this ).Cast();
					if ( !SpellRune.DisSpirit && Type == RuneType.Spirit )
						new Server.Spells.UndeadLegionSpell( from, null, this ).Cast();
					if ( !SpellRune.DisLightning && Type == RuneType.Lightning )
						new Server.Spells.EnergySource( from, null, this ).Cast();
					if ( !SpellRune.DisToxic && Type == RuneType.Toxic )
						new Server.Spells.PlagueSpore( from, null, this ).Cast();
					if ( !SpellRune.DisIce && Type == RuneType.Ice )
						new Server.Spells.IceMeteor( from, null, this ).Cast();
					if ( !SpellRune.DisVoid && Type == RuneType.Void )
						new Server.Spells.NoFaceSpell( from, null, this ).Cast();
				}
						else if ( Spell5 && Spell5Keyword != null && Spell5Keyword != "" && e.Speech.ToLower() == Spell5Keyword.ToLower() )
						{
