...
namespace Server.Mobiles
{
	...
	public class AmberElemental : BaseCreature
	{
		[Constructable]
		public AmberElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an amber elemental";
			Body = 14;
			BaseSoundID = 268;
		...
		public AmberElemental( Serial serial ) : base( serial )
		{
		}
