...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public AmethystElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public void ThrowGem( IDamageable m )
		{
			...
			this.MovingParticles( m, 0xF16, 1, 0, false, false, 0, 0, 9502, 6014, 0x11D, EffectLayer.Waist, 0 );
		...
		public AmethystElemental( Serial serial ) : base( serial )
		{
		}
