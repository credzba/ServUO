...
namespace Server.Mobiles
{
	...
	public class TourmalineElemental : BaseCreature
	{
		[Constructable]
		public TourmalineElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an tourmaline elemental";
			Body = 14;
			BaseSoundID = 268;
			...
			SetSkill( SkillName.Tactics, 65.0, 105.0 );
			SetSkill( SkillName.Wrestling, 65.0, 105.0 );
		...
		public override void OnGotMeleeAttack( Mobile attacker )
		{
			...
			Tourmaline item = new Tourmaline();
		...
		public void ThrowGem( IDamageable m )
		{
			...
			this.MovingParticles( m, 0xF2D, 1, 0, false, false, 0, 0, 9502, 6014, 0x11D, EffectLayer.Waist, 0 );
		...
		{
			private IDamageable m_Mobile, m_From;

			public InternalTimer( IDamageable m, IDamageable from ) : base( TimeSpan.FromSeconds( 1.0 ) )
			{
				m_Mobile = m;
				m_From = from;
		...
		public TourmalineElemental( Serial serial ) : base( serial )
		{
		}
