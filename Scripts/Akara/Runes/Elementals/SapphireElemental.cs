...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public SapphireElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an sapphire elemental";
			Body = 14;
			BaseSoundID = 268;
		...
		public void ThrowGem( IDamageable m )
		{
			...
			this.MovingParticles( m, 0xF19, 1, 0, false, false, 0, 0, 9502, 6014, 0x11D, EffectLayer.Waist, 0 );
