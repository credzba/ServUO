...
namespace Server.Mobiles
{
	...
	public class RubyElemental : BaseCreature
	{
		[Constructable]
		public RubyElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an ruby elemental";
			Body = 14;
			BaseSoundID = 268;
		...
		public void ThrowGem( IDamageable m )
		{
			...
			this.MovingParticles( m, 0xF13, 1, 0, false, false, 0, 0, 9502, 6014, 0x11D, EffectLayer.Waist, 0 );
		...
		public RubyElemental( Serial serial ) : base( serial )
		{
		}
