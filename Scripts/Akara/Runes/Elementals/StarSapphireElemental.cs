...
namespace Server.Mobiles
{
	...
	public class StarSapphireElemental : BaseCreature
	{
		[Constructable]
		public StarSapphireElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an star sapphire elemental";
			Body = 14;
			BaseSoundID = 268;
			...
			SetSkill( SkillName.MagicResist, 70.0, 100.0 );
		...
		public override void OnGotMeleeAttack( Mobile attacker )
		{
			...
			StarSapphire item = new StarSapphire();
		...
		public void ThrowGem( IDamageable m )
		{
			...
			this.MovingParticles( m, 0xF25, 1, 0, false, false, 0, 0, 9502, 6014, 0x11D, EffectLayer.Waist, 0 );
		...
		public StarSapphireElemental( Serial serial ) : base( serial )
		{
		}
