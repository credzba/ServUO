...
namespace Server.Mobiles
{
	...
	public class EmeraldElemental : BaseCreature
	{
		[Constructable]
		public EmeraldElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an emerald elemental";
			Body = 14;
			BaseSoundID = 268;
			...
			SetSkill( SkillName.Tactics, 70.0, 110.0 );
		...
		public void ThrowGem( IDamageable m )
		{
			...
			this.MovingParticles( m, 0xF10, 1, 0, false, false, 0, 0, 9502, 6014, 0x11D, EffectLayer.Waist, 0 );
		...
		public EmeraldElemental( Serial serial ) : base( serial )
		{
		}
